"""Xception network architecture for deepfake detection."""
...
class Xception(nn.Module):
    """Full Xception model matching FaceForensics++ benchmark architecture."""
...
def return_xception(num_classes: int = 2) -> Xception:
